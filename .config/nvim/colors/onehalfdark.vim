...
let s:yellow      = { "gui": "#e5c07b", "cterm": "222" }
let s:blue        = { "gui": "#61afef", "cterm": "75"  }
let s:purple      = { "gui": "#c678dd", "cterm": "176" }
let s:cyan        = { "gui": "#56b6c2", "cterm": "51"  }
let s:white       = { "gui": "#dcdfe4", "cterm": "188" }
let s:l_yellow    = { "gui": "#ffff99", "cterm": "230"}

let s:fg          = s:l_yellow
let s:bg          = s:black

let s:comment_fg  = { "gui": "#999999", "cterm": "247" }
let s:gutter_bg   = { "gui": "#282c34", "cterm": "000" }
let s:gutter_fg   = { "gui": "#919baa", "cterm": "80" }
