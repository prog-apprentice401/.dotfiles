...
-- emptied the function to use feh instead
...
-------- Launchers
	...
	awful.key({ modkey, }, "s",
		...
		{description = "Launch AlsaMixer", group = "programs"}
	),
	awful.key({ modkey, }, "x",
		function ()
...
-------- Prompt
	awful.key({ modkey }, "d",
		function ()
			awful.spawn.with_shell("rofi -modi drun#run -show drun -show-icons -icon-theme 'Tela Circle Pink Dark'")
		end,
...
awful.spawn.with_shell("guake-toggle")
